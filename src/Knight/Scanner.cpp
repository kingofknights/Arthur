...
#define PARAM_FUNCTION_LIST_2 \
    BOOST_PP_TUPLE_TO_LIST(23, (ATP, PercentChange, Open, High, Low, Close, HighDPR, LowDPR, TotalBuyQuantity, TotalSellQuantity, VolumeTradedToday, OpenInterest, LTP, LTQ, BidDepth, AskDepth, Expiry, ExpiryWeek, IsCall, IsPut, IsFuture))
